...
export async function SiteFooter() {
  ...
  </div><div className="border-t border-black/10"><p className="site-shell py-5 text-xs text-black/55">© {new Date().getFullYear()} {settings?.title || "Dynamics Commerce"}. All rights reserved.</p></div></footer>;
}
