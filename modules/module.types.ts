...
export interface ModuleDefinition { schemaVersion: 1; friendlyName: string; name: string; description: string; categories: string[]; tags: string[]; config: Record<string, ModuleDefinitionField>; resources: Record<string, { value: ModulePrimitive; comment?: string; group?: string }>; }
