...
export interface ModuleDataActionDefinition { friendlyName: string; description?: string; endpoint: string; method: "GET"; defaultExecution: ModuleDataExecution; allowedExecutions: ModuleDataExecution[]; }
